/*
 * LDAP2PTRTiedEgoCentricNetworkData.cpp
 *
 *  Created on: Jan 13, 2011
 *      Author: duyvu
 */

#include "LDAP2PTRTiedEgoCentricNetworkData.h"
...
LDAP2PTRTiedEgoCentricNetworkData::LDAP2PTRTiedEgoCentricNetworkData() {
...
LDAP2PTRTiedEgoCentricNetworkData::LDAP2PTRTiedEgoCentricNetworkData(
	...
	cout << "START the constructor of LDAP2PTRTiedEgoCentricNetworkData"
			<< endl;
	...
	for (unsigned int i = 0; i < numOfVertices; i++) {
		if (nodeJoiningTimes[i] < nextCitingTime) {
			for (unsigned int k = 0, ldaIndex = 8; k < NUMBER_OF_LDA_TOPICS; k++, ldaIndex++)
				currentNodalNetworkStatistics(i, ldaIndex) = LDA(i, k) * LDA(
						nextCitingNode, k);
		} else
			break;
	}
	...
	cout << "FINISH the constructor of LDAP2PTRTiedEgoCentricNetworkData"
			<< endl;
}
...
void LDAP2PTRTiedEgoCentricNetworkData::updateNodalNetworkStatisticsCache(
...
void LDAP2PTRTiedEgoCentricNetworkData::updateNodalNetworkStatistics(
...
int LDAP2PTRTiedEgoCentricNetworkData::getFirstOrderPopularityIndex() {
	return 0;
}
