/*
 * P2PTGroupedEgoCentricNetworkData.cpp
 *
 *  Created on: Jan 18, 2011
 *      Author: duyvu
 */

#include "P2PTGroupedEgoCentricNetworkData.h"

namespace ndip {

P2PTGroupedEgoCentricNetworkData::P2PTGroupedEgoCentricNetworkData() {
...
P2PTGroupedEgoCentricNetworkData::P2PTGroupedEgoCentricNetworkData(
	...
	cout << "START the constructor of P2PTGroupedEgoCentricNetworkData" << endl;

	// Initialize the current nodal network statistics
	numOfNodalNetworkStatistics
			= P2PTGroupedEgoCentricNetworkData::NUMBER_OF_NODAL_NETWORK_STATISTICS;
	...
	cout << "FINISH the constructor of P2PTGroupedEgoCentricNetworkData"
			<< endl;
}
...
void P2PTGroupedEgoCentricNetworkData::updateNodalNetworkStatisticsCache(
...
void P2PTGroupedEgoCentricNetworkData::updateNodalNetworkStatistics(
...
int P2PTGroupedEgoCentricNetworkData::getFirstOrderPopularityIndex() {
	return 0;
}
